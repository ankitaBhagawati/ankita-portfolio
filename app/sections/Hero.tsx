      ...
      <div className="max-w-6xl mx-auto px-4 md:px-12 w-full">
        <div className="py-20 max-w-3xl">
          ...
          <motion.h1
            ...
            className="font-display font-extrabold tracking-[-0.04em] leading-[1.02] mb-3"
          ...
          <motion.p
            ...
            className="text-white/50 mb-5 font-medium"
          ...
          <motion.p
            ...
            className="text-[#b0b6cc] text-[0.93rem] leading-[1.78] mb-10 max-w-xl"
          >
            {resume.summary}
          </motion.p>
